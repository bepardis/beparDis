...
### 🇮🇷 راهکاری ساده، رایگان و مدرن برای رفع محدودیت دسترسی به برنامه‌ها

**ساخته شده برای مردم عزیز ایران**
...
این پروژه به صورت رایگان در اختیار کاربران قرار گرفته است و در صورت حمایت کاربران، برنامه‌ها و سرویس‌های بیشتری در نسخه‌های آینده به آن اضافه خواهند شد.
...
* 🆓 کاملاً رایگان
* 💬 پشتیبانی از Discord
* 🌐 استفاده از چندین سرور و مسیر ارتباطی
* ⚡ عملکرد سریع و بهینه
* 🎨 رابط کاربری مدرن و کاربرپسند
* 🪶 سبک و کم‌مصرف
* 🇮🇷 توسعه یافته برای کاربران ایرانی
* 🚀 قابلیت گسترش و افزودن سرویس‌های جدید

---

## ❤️ رایگان برای همیشه

این نرم‌افزار در حال حاضر **کاملاً رایگان** بوده و استفاده از آن نیازی به پرداخت هزینه یا اشتراک ندارد.
...
### 🌍 A Free and Modern Solution for Accessing Supported Applications

**Built with care for users in Iran**
...
* 🆓 Completely Free
* 💬 Discord Support
* 🌐 Multiple Servers and Connection Routes
* ⚡ Fast and Optimized Performance
* 🎨 Modern User Interface
* 🪶 Lightweight Design
* 🇮🇷 Developed for Iranian Users
* 🚀 Future Expansion and New Services
